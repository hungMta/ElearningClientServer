module.exports = Object.freeze({
    ...
    LIMIT: 20,
    INSERT_ENROLL:'INSERT INTO `enroll` (`iduser`, `idcourse`) ',
    QUIT_ENROLL:'DELETE FROM `enroll`',
    DELETE_PATHWAY:'DELETE FROM pathway`',
    SELECT_ALL_WORD:'select * from word',
    SELECT_ALL_LESSON:'select * from lesson',
    INSERT_PATHWAY:'INSERT INTO `pathway` (`iduser`, `idcourse`, `idlesson`, `score`)',
